    ...
    <div class="main-border">
        <div class="main-header">
            ...
            <div class="header-right">
                ...
                <img :src="user.imageUrl" @mouseover="cardshow" @mouseout="cardshow" @error="defaultImg"/>
            </div>
        </div>
        <transition name="fade">
            <div class="mycard" v-show="isCardShow"  @mouseover="cardshow" @mouseout="cardshow">
        ...
        <div class="main-left">
            <div class="myimg">
                <img class="leftimg" :src="user.imageUrl" @mouseover="cardshow" @mouseout="cardshow" @error="defaultImg"/>
                <span>{{user.name}}</span>
            </div>
            <div class="hr"></div>
            <MenuGroup/>
